...
let ans1 = stkmc ([],[("x", Num (1))], (compile (Variable "y")), []) ;;
Printf.printf "\nAnswer is:    ";;
print_answer ans1;;
let ans2 = stkmc ([],[("x", Num (1))], (compile (Variable "x")), []) ;;
Printf.printf "\nAnswer 2 is:    ";;
print_answer ans2;;
let ans3 = stkmc ([], [("x", Closure("x", [FIND_VARIABLE "y"; RETURN], [("y", Num (2))])); ("y", Num (1))], (compile (Apply(Variable "x", Variable "y"))), [] );;
Printf.printf "\nAnswer 3 is:    ";;
print_answer ans3;;
let ans4 = stkmc([], [("x", Num (1))], (compile (Apply(Abstract("x", Variable "x"), Variable "x"))), []) ;;
Printf.printf "\nAnswer 4 is:    ";;
print_answer ans4;;
let ans5 = stkmc([], [("x", Num (1)); ("y", Num (2))], (compile (Apply(Abstract("y", Variable "y"), Variable "x"))), []) ;;
Printf.printf "\nAnswer 5 is:    ";;
print_answer ans5;;
let ans6 = stkmc ([], [("x", Num (1)); ("y", Num (2))], (compile (Apply(Abstract("y", Abstract("x", Variable "y")), Variable "x"))), []) ;;
Printf.printf "\nAnswer 6 is:    ";;
print_answer ans6;;
let ans7 = stkmc ([], [("x", Num (1)); ("y", Num (2))], (compile (Apply(Abstract("x", Apply(Abstract("y", Variable "y"), Variable "x")), Variable "x"))), []) ;;
Printf.printf "\nAnswer 7 is:    ";;
print_answer ans7;;